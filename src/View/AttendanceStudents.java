...
public class AttendanceStudents extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AttendanceStudents frame = new AttendanceStudents();
	...
	public AttendanceStudents() {
		...
		textField.setBounds(220, 11, 262, 34);
		...
		btnNewButton_1.setBounds(529, 11, 98, 34);
		panel_3.add(btnNewButton_1);
		
		JButton btnNewButton_2 = new JButton("Chia s\u1EBB t\u00E0i li\u1EC7u");
		btnNewButton_2.setBackground(new Color(47, 79, 79));
		btnNewButton_2.setFont(new Font("Arial", Font.PLAIN, 13));
		btnNewButton_2.setForeground(Color.WHITE);
		btnNewButton_2.setBounds(975, 11, 120, 34);
